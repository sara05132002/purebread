	...
	<nav class="navbar navbar-expand-lg navbar-light  bgnav"><div class="container">
		...
		<div class="collapse navbar-collapse navsit" id="navbarNavAltMarkup">
			<div class="navbar-nav">
		      <a class="nav-item nav-link active" href="about01.php"><img src="images/iconbread.png">關於</a>
...
<div class="container">
	...
	<div class="show">
		<table class="table table-all table-hover">
			<thead>
				<tr>
					<th colspan="2" class="thead-a"><a href="reply01.php?id=<?php echo $rs['guestID'] ?>">回覆</a><a href="delete.php?id=<?php echo $rs['guestID'] ?>">刪除</a></th>
